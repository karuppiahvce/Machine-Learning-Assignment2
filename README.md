...
🔗 **[https://github.com/karuppiahvce/2025da04031-ML-Assignment2](https://github.com/Ykaruppiahvce/2025da04031-ML-Assignment2)**
...
| **Overall Winner for your dataset?** | **Random Forest (Ensemble)** — it dominates all five other models across every evaluation metric (Accuracy, AUC, Precision, Recall, F1, and MCC), making it the clear and unambiguous choice for deployment on this grid-stability dataset. This is also the model used as the primary predictor in the accompanying Streamlit application. |
